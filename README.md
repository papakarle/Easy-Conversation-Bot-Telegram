...
if __name__ == "__main__":
    main()
```
### Вот и всё, ваш бот готов. Если вы всё правильно делали, то справа в верхнем углу будет треугольник запуска, тыкаем в него. <span style="color:blue">Не забудьте указать API вашего бота в 127 строчке!!!</span>
